// node_modules/@schedule-x/resize/dist/core.js
...
var updateEventsList = ($app, calendarEvent, oldEventEnd, newEventEnd) => {
...
var TimeGridEventResizer = class {
  ...
  setNewTimeForEventEnd(pointsToAdd) {
    ...
    if (newEnd > this.dayBoundariesDateTime.end || newEnd <= this.calendarEvent.start)
      return;
...
var DateGridEventResizer = class {
  ...
  setNewTimeForEventEnd(daysToAdd) {
    ...
    if (newEnd > this.$app.calendarState.range.value.end || newEnd < this.calendarEvent.start || newEnd < toDateString(toJSDate(this.$app.calendarState.range.value.start)))
      return;
    updateEventsList(this.$app, this.calendarEvent, endBeforeUpdate, newEnd);
  }
};
var ResizePluginImpl = class {
  constructor() {
...
var createResizePlugin = () => new ResizePluginImpl();
export {
  createResizePlugin
};
//# sourceMappingURL=@schedule-x_resize.js.map
