...
interface EventModalPlugin extends PluginBase {
    ...
    setCalendarEvent(event: CalendarEventInternal | null, eventTargetDOMReact: DOMRect | null): void;
...
interface ReducedCalendarConfigInternal extends Omit<CalendarConfigInternal, "dayBoundaries" | "isHybridDay" | "plugins" | "views" | "_customComponentFns"> {
}
...
declare const setRangeForWeek: (config: RangeSetterConfig) => void;
declare const setRangeForMonth: (config: RangeSetterConfig) => void;
declare const setRangeForDay: (config: RangeSetterConfig) => void;
